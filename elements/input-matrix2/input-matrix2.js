Polymer({
  ...
  __doc__: {
    element: 'input-matrix2',
    description: 'Input element for matrix2 data type.',
    status: 'alpha',
    url: 'https://github.com/arodic/input-matrix2/',
    demo: 'http://arodic.github.com/input-matrix2/',
    attributes: [
