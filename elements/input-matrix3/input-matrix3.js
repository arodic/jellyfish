Polymer({
  ...
  __doc__: {
    element: 'input-matrix3',
    description: 'Input element for matrix3 data type.',
    status: 'alpha',
    url: 'https://github.com/arodic/input-matrix3/',
    demo: 'http://arodic.github.com/input-matrix3/',
    attributes: [
