Polymer({
  ...
  __doc__: {
    element: 'input-vector3',
    description: 'Input element for vector3 data type.',
    status: 'alpha',
    url: 'https://github.com/arodic/input-vector3/',
    demo: 'http://arodic.github.com/input-vector3/',
    attributes: [
